> For the complete documentation index, see [llms.txt](https://docs.bleh.rest/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.bleh.rest/server/messages.md).
...
```
GET https://docs.bleh.rest/server/messages.md?ask=<question>&goal=<endgoal>
```
