> For the complete documentation index, see [llms.txt](https://docs.bleh.rest/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.bleh.rest/server/messages/button.md).
...
{% hint style="warning" %}
Button roles can only be placed on messages & embeds sent by bleh. Learn how to create an embed [**here**](https://docs.bleh.rest/resources/scripting/embeds)!
{% endhint %}
...
```
GET https://docs.bleh.rest/server/messages/button.md?ask=<question>&goal=<endgoal>
```
